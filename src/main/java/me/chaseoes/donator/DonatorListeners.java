...
public class DonatorListeners implements Listener {

	public Donator plugin;
	public DonatorListeners(Donator plugin) {
		this.plugin = plugin;
	}
	...
	public void onPlayerInteract(PlayerInteractEvent event) {
		...
		if (player.hasPermission("donator.setwall") && player.getItemInHand().getType() == Material.GOLD_AXE && Donator.settingwall.contains(player.getName())) {
